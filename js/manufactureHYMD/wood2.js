$(document).ready(function() {
	...
	$("#wood1").click(function() {
		...
		setTimeout(function() {
			...
			$(".helpPicWrapper").css("display", "none");
		}, 5000);
	})
	...
	$("#help").hover(function() {
		...
		$(".tipsContent").html("&emsp;&emsp;选用木料直接关系到作品的质量问题。在一般情况下木料的选用是根据泥稿的大小而选用的。可采用的黄杨木料，首先应是木头形体平圆而直，并无节疤获肿瘤突出，树皮细匀，再将两头锯过过，两端轮纹细，鲜黄色纯，内无含疤节，这就是适合雕刻的优良质量的木料。<br>&emsp;&emsp;木料我们一般都要阴干一两年，最少要经过一个秋冬季，等木质性能稳定后再用；另外春夏采伐的木料因为水分含量高而材质不稳，容易蓝变和干裂，一般不采用。");
