				...
				if(i == 1){
					...
					for(var j = 1; j < 9; j++){
						...
						$.ajax({
							...
							dataType: "json",
							async: false,
							data: {answer: $answer, telephone: $telephone, question: $question, accuracy: "testYDW1"},
							success: function(data) {
					...
					for(var j = 1; j < 6; j++){
						...
						$.ajax({
							...
							dataType: "json",
							async: false,
							data: {answer: $answer, telephone: $telephone, question: $question, accuracy: "testYDW2"},
							success: function(data) {
					...
					for(var j = 1; j < 6; j++){
						...
						$.ajax({
							...
							dataType: "json",
							async: false,
							data: {answer: $answer, telephone: $telephone, question: $question, accuracy: "testYDW3"},
							success: function(data) {
